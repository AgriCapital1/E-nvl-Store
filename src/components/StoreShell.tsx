...
export function StoreFooter() {
  ...
  return (
    <footer className="mt-16 border-t border-border/60 py-8 pb-24 sm:pb-8">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-1 px-4 text-sm text-muted-foreground">
        <p className="text-foreground">E'nvlé Store — Abidjan, Côte d'Ivoire</p>
